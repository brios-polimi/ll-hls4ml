...
class CDFGInputProjection(nn.Module):
    ...
    Expected node feature layout:
        ...
        function:    FloatTensor of shape (N, FUNCTION_FEATURE_SIZE)
    """
    ...
    def __init__(
        ...
        self.function_emb = MultilayerDense(FUNCTION_FEATURE_SIZE, hidden_dim, n_layers)
    ...
    def forward(self, x_dict):
        ...
        h_dict["function"] = self.function_emb(x_dict["function"])
